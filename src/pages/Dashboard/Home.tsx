  ...
  return (
    <>
      ...
      <div className="space-y-6 animate-fadeIn">
        ...
        <div className={`grid ${[showObrasCard, showLibrosCard, showVisitantesCard, showEventosCard].filter(Boolean).length === 4 ? "grid-cols-2 sm:grid-cols-2 lg:grid-cols-4" : [showObrasCard, showLibrosCard, showVisitantesCard, showEventosCard].filter(Boolean).length === 3 ? "grid-cols-2 sm:grid-cols-2 lg:grid-cols-3" : [showObrasCard, showLibrosCard, showVisitantesCard, showEventosCard].filter(Boolean).length === 2 ? "grid-cols-2 sm:grid-cols-2" : "grid-cols-1"} gap-3 md:gap-6`}>
          {/* Obra Metric */}
          {showObrasCard && (
