          ...
          <form onSubmit={handleRegistrarMenor} className="space-y-4">
            ...
            {menorData.fecha_nacimiento && ageMenor >= 9 && ageMenor <= 13 && (
              <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-300 dark:border-yellow-800 text-yellow-800 dark:text-yellow-300 rounded-lg px-3 py-2 text-sm flex items-center gap-2">
                <svg className="w-4 h-4 text-yellow-600 dark:text-yellow-400 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L4.072 16.5c-.77.833.192 2.5 1.732 2.5z" /></svg> Este menor tiene {ageMenor} años. Se recomienda tramitar su cédula de identidad pronto.
              </div>
            )}
            {menorData.fecha_nacimiento && ageMenor >= 12 && (
              <div className="bg-red-50 dark:bg-red-900/20 border border-red-300 dark:border-red-800 text-red-700 dark:text-red-300 rounded-lg px-3 py-2 text-sm flex items-center gap-2">
                <svg className="w-4 h-4 text-red-600 dark:text-red-400 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728A9 9 0 015.636 5.636m12.728 12.728L5.636 5.636" /></svg> No se puede registrar como menor. A partir de 12 años debe registrarse como visitante regular.
              </div>
            )}
