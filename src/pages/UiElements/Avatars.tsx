...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | MAVET - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for MAVET - React.js Tailwind CSS Admin Dashboard Template"
      />
