...
export default function Videos() {
  return (
    <>
      <PageMeta
        title="React.js Videos Tabs | MAVET - React.js Admin Dashboard Template"
        description="This is React.js Videos page for MAVET - React.js Tailwind CSS Admin Dashboard Template"
      />
