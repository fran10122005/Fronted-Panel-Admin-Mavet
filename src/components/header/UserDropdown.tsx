...
export default function UserDropdown() {
  ...
  return (
    <div className="relative">
      ...
      >
        <span className="overflow-hidden rounded-full h-11 w-11 border-2 border-gray-200 dark:border-gray-700 transition-colors duration-300 bg-gray-100 dark:bg-gray-800 flex items-center justify-center">
          {fotoUrl ? (
            <img src={fotoUrl} alt="Foto" className="w-full h-full object-cover" />
          ) : (
            <div className="w-full h-full flex items-center justify-center bg-brand-100 text-brand-600 font-bold text-[15px] font-serif">
